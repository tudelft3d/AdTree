...
AdTree depends on some third-party libraries and **all dependencies are included** in the distribution. So you do not need to do anything about third-party libraries. **NOTE**: AdTree uses a stripped and earlier version of [Easy3D](https://github.com/LiangliangNan/Easy3D), which is not compitable with the recent version.
